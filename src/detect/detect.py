...
def inference(model, imgs, imgsz=(640, 640), conf_thres=0.25, iou_thres=0.45, max_det=1000, classes=None, agnostic_nms=False, augment=False, visualize=False):
    ...
    for j, im0 in enumerate(imgs):
        ...
        print(j)
        cv2.imwrite(f'output_{j}.jpg', im0)
